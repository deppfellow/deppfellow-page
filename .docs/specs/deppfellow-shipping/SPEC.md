...
| T5 (td-7e73c8)  | Resolution pass: wikilinks (registry-bound, degrade-to-plain-text), `_assets/` images, footnotes, task lists, inline tags; emits graph neighbors. | agent-owned | T1                |     | T6 (td-9a444b) | Reading page: metadata header, 65ch markdown (core + callouts + math + tables/code/blockquote), back + prev/next. | human-owned | T5  |
